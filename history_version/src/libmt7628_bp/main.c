...
int main(){
	...
	main_signal.init_signal = 0;
    int pthread_creat_erro = pthread_create(&serial_config_thread, NULL, serial_config_api, &main_signal);
	printf("ok4");
	...
	pthread_cond_wait(&main_signal.cond_main, &lock_tmp);
